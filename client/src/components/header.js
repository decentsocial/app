...
function svgLoading () {
  return <svg width='24' height='24' viewBox='0 0 16 16' class={`bi bi-arrow-repeat ${styles.rotate}`} fill='currentColor' xmlns='http://www.w3.org/2000/svg'>
...
function svgMenu () {
  return <svg viewBox='0 0 60 60' width='24' height='24'>
